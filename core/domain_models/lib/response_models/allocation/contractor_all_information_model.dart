...
class ContractorResult {
  ...
  ContractorResult.fromJson(Map<String, dynamic> json) {
    ...
    if (json['userAdminList'] != null && (json['userAdminList']).isNotEmpty) {
    ...
    if (json['feedbackTemplate'] != null &&
        (json['feedbackTemplate']).isNotEmpty) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (userAdminList != null && userAdminList!.isNotEmpty) {
      data['userAdminList'] = userAdminList!.map((v) => v.toJson()).toList();
    }
    if (feedbackTemplate != null && feedbackTemplate!.isNotEmpty) {
...
class MyCasesQueue {
  ...
  MyCasesQueue.fromJson(Map<String, dynamic> json) {
    ...
    if (json['last3DayEventOrder'] != null &&
        json['last3DayEventOrder'].isNotEmpty) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (last3DayEventOrder != null && last3DayEventOrder!.isNotEmpty) {
...
class Feedback {
  ...
  Feedback.fromJson(Map<String, dynamic> json) {
    ...
    if (json['fields'] != null && json['fields'].isNotEmpty) {
      fields = <Fields>[];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['options'] != null && json['options'].isNotEmpty) {
      options = <Options>[];
