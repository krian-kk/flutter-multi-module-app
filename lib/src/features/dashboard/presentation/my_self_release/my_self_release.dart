...
//
// class MySelfReleaseBottomSheet extends StatefulWidget {
//   const MySelfReleaseBottomSheet(this.bloc, {Key? key}) : super(key: key);
//   final DashboardBloc bloc;
//
//   @override
//   _MySelfReleaseBottomSheetState createState() =>
//       _MySelfReleaseBottomSheetState();
// }
//
// class _MySelfReleaseBottomSheetState extends State<MySelfReleaseBottomSheet> {
//   // late MySelfReleaseBloc bloc;
//
...
//         }
//
//         if (state is ReturnSelfReleaseApiState) {
//           setState(() {
//             widget.bloc.mySelfReleaseData =
//                 MySelfReleaseResult.fromJson(state.returnData);
//           });
//         }
//
...
//                                         ),
//                                         // CustomText(
//                                         //   widget.bloc.mySelfReleaseData.result!
//                                         //       .totalCount
//                                         //       .toString(),
//                                         //   color: ColorResource.color101010,
...
//             });
//             widget.bloc.add(SelfReleaseApiEvent(timePeriod: Constants.today));
//             break;
//           case '1':
//             setState(() {
...
//             });
//             widget.bloc.add(SelfReleaseApiEvent(timePeriod: Constants.weeklY));
//             break;
//           case '2':
//             setState(() {
...
//             });
//             widget.bloc.add(SelfReleaseApiEvent(timePeriod: Constants.monthly));
//             break;
//           default:
//         }
//         // setState(() {
...
class MySelfReleaseBottomSheetWidget extends StatelessWidget {
  const MySelfReleaseBottomSheetWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return const MySelfReleaseBottomSheet();
  }
}

class MySelfReleaseBottomSheet extends StatefulWidget {
  const MySelfReleaseBottomSheet({Key? key}) : super(key: key);

  @override
  MySelfReleaseBottomSheetState createState() =>
      MySelfReleaseBottomSheetState();
}

class MySelfReleaseBottomSheetState extends State<MySelfReleaseBottomSheet> {
  @override
  Widget build(BuildContext context) {
    return BlocListener<DashboardBloc, DashboardState>(
      ...
      onTap: () {
        switch (option) {
          case '0':
            ...
            BlocProvider.of<DashboardBloc>(context)
                .add(SelfReleaseApiEvent(timePeriod: Constants.today));
            break;
          case '1':
            setState(() {
              BlocProvider.of<DashboardBloc>(context).selectedFilter =
            ...
            BlocProvider.of<DashboardBloc>(context)
                .add(SelfReleaseApiEvent(timePeriod: Constants.weeklY));
            break;
          case '2':
            setState(() {
              BlocProvider.of<DashboardBloc>(context).selectedFilter =
            ...
            BlocProvider.of<DashboardBloc>(context)
                .add(SelfReleaseApiEvent(timePeriod: Constants.monthly));
            break;
          default:
        }
      },
