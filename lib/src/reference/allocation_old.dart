...
//     BlocProvider.of<AllocationBloc>(context).add(TapPriorityEvent());
//   }
//
...
//         if (BlocProvider.of<AllocationBloc>(context).isShowSearchPincode) {
//         } else if (BlocProvider.of<AllocationBloc>(context)
//             .isPriorityLoadMore) {
//           BlocProvider.of<AllocationBloc>(context).page += 1;
//           BlocProvider.of<AllocationBloc>(context).add(PriorityLoadMoreEvent());
//         } else {
//           BlocProvider.of<AllocationBloc>(context).page += 1;
//           BlocProvider.of<AllocationBloc>(context)
//               .add(BuildRouteLoadMoreEvent());
//         }
//       }
//     }
//   }
...
//           height: 7,
//         ),
//         BlocProvider.of<AllocationBloc>(context).currentAddress != null
//             ? Row(
//                 children: [
//                   const SizedBox(
//                     width: 5,
...
//                     width: 213,
//                     child: CustomText(
//                       BlocProvider.of<AllocationBloc>(context).currentAddress!,
...
//         }
//         setState(() {
//           BlocProvider.of<AllocationBloc>(context).selectedDistance = distance;
//           BlocProvider.of<AllocationBloc>(context).add(TapBuildRouteEvent(
...
//           border:
//               Border.all(color: ColorResourceDesign.color23375A, width: 0.5),
//           borderRadius: BorderRadius.circular(85),
//           color: distance ==
//                   BlocProvider.of<AllocationBloc>(context).selectedDistance
...
//     return BlocListener(listener: (BuildContext context, state) async {
...
//       }
//     }, child:
//         BlocBuilder<AllocationBloc, AllocationState>(builder: (context, state) {
//       if (state is MapViewLoadingState) {
...
//                         border:
//                             Border.all(color: ColorResourceDesign.colorECECEC),
//                       ),
//                       child: Row(
//                         children: [
//                           Expanded(
...
//                             fontWeight: FontWeight.w700,
//                             color: index ==
//                                     BlocProvider.of<AllocationBloc>(context).tab
//                                 ? Colors.white
//                                 : ColorResourceDesign.color000000,
//                           ),
//                           selected:
//                               BlocProvider.of<AllocationBloc>(context).tab ==
//                                   index,
//                           selectedColor: ColorResourceDesign.color23375A,
//                           onSelected: (value) {
//                             if (index != 2) {
//                               setState(() {
//                                 BlocProvider.of<AllocationBloc>(context).tab =
...
//                                   setState(() {
//                                     BlocProvider.of<AllocationBloc>(context)
//                                         .add(TapBuildRouteEvent(
//                                       paramValues: BuildRouteDataModel(
//                                           lat: BlocProvider.of<AllocationBloc>(
//                                                   context)
//                                               .position
//                                               .latitude
//                                               .toString(),
//                                           long: BlocProvider.of<AllocationBloc>(
//                                                   context)
//                                               .position
//                                               .longitude
//                                               .toString(),
...
//                                     ));
//                                     BlocProvider.of<AllocationBloc>(context)
//                                       ..showFilterDistance = true;
//                                   });
//                                 } else {
//                                   // BlocProvider.of<AllocationBloc>(context)..add(ShowAutoCallingEvent());
//                                 }
//                                 break;
//                               case 2:
//                                 BlocProvider.of<AllocationBloc>(context)
...
//                     height: 13.0,
//                   ),
//                   BlocProvider.of<AllocationBloc>(context).showFilterDistance
//                       ? _buildBuildRoute()
//                       : const SizedBox(),
//                   Expanded(
