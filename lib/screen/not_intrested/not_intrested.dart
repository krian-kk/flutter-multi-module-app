...
class CustomNotIntrestedBottomSheet extends StatefulWidget {
  ...
  @override
  State<CustomNotIntrestedBottomSheet> createState() =>
      _CustomNotIntrestedBottomSheetState();
}
...
class _CustomNotIntrestedBottomSheetState
  ...
  Widget build(BuildContext context) {
    List<String> dropdownValues = [
      StringResource.enquiryCall,
      StringResource.rateIssue,
      StringResource.documentIssue,
    ];
                            ...
                            children: <Widget>[
                              ...
                              DropDownButton(
                                ...
                                hintWidget: CustomText(
                                  Languages.of(context)!.reasonForNotIntrested,
  ...
  submitNotInterestedEvent(bool stopValue) async {
      ...
      if (_formKey.currentState!.validate()) {
        ...
        if (isNotAutoCalling) {
          ...
          final NotEligiblePostEvent requestBodyData = NotEligiblePostEvent(
            ...
            eventCode: ConstantEventValues.notInterestedEvenCode,
            ...
            eventAttr: EventAttr(
              reasonForNotInterested: selectedDropdownValue,
          ...
          if (ConnectivityResult.none ==
            ...
            if (postResult[Constants.success]) {
              ...
              if (!(widget.userType == Constants.fieldagent &&
                ...
                widget.bloc.add(
                  ChangeIsSubmitEvent(
                      selectedClipValue: Constants.notInterested),
                );
              }
