              ...
              children: [
                Expanded(
                  child: GestureDetector(
                    onTap: () => addressDetailsShowBottomSheet(),
                    child: Container(
                      height: 50,
                      decoration: new BoxDecoration(
                          border: Border.all(
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () => callDetailsShowBottomSheet(),
                    child: Container(
                      height: 50,
                      decoration: new BoxDecoration(
                          border: Border.all(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            CustomText(
                              StringResource.addressDetails.toUpperCase(),
                              fontSize: FontSize.fourteen,
                              fontWeight: FontWeight.w700,
                              fontStyle: FontStyle.normal,
                              color: ColorResource.color23375A,
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            CustomText(
                              StringResource.callDetails.toUpperCase(),
                              fontSize: FontSize.fourteen,
                              fontWeight: FontWeight.w700,
                              fontStyle: FontStyle.normal,
                              color: ColorResource.color23375A,
