...
class _CustomEventDetailsBottomSheetState
  ...
  //   List<dynamic> value = [
  //               {
  //                   '_id': '62c409f54b58bcece39e6cd8',
  //                   'caseId': '62500dcaed542012a1d9f49f',
  //                   'eventType': 'CALL TRIED',
  //                   'eventAttr': {
  //                       'invalidNumber': false,
  //                       'callId': 'c2c_62c409ec3be1d188',
  //                       'repo': {
  //                           'imageLocation': []
  //                       },
  //                       'imageLocation': [],
  ...
  //                   },
  //                   'eventCode': 'TELEVT011',
  //                   'createdAt': '2022-07-24T00:00:00.000Z',
  //                   'createdBy': 'CDE_45',
  //                   'eventModule': 'Telecalling',
  //                   'agrRef': 'O25',
  //                   'contractor': 'C0026',
  ...
  //               },
  //               {
  //                   '_id': '62c409a04b58bcece39e6cc2',
  //                   'caseId': '62500dcaed542012a1d9f49f',
  //                   'eventType': 'CALL TRIED',
  //                   'eventAttr': {
  //                       'invalidNumber': false,
  //                       'callId': 'c2c_62c409975b6dd162',
  //                       'repo': {
  //                           'imageLocation': []
  //                       },
  //                       'imageLocation': [],
  ...
  //                   },
  //                   'eventCode': 'TELEVT011',
  //                   'createdAt': '2022-07-05T09:51:28.138Z',
  //                   'createdBy': 'CDE_45',
  //                   'eventModule': 'Telecalling',
  //                   'agrRef': 'O25',
  //                   'contractor': 'C0026',
  ...
  //                   },
  //                   'eventCode': 'TELEVT011',
  //                   'createdAt': '2022-08-05T09:51:28.138Z',
  //                   'createdBy': 'CDE_45',
  //                   'eventModule': 'Telecalling',
  //                   'agrRef': 'O25',
  //                   'contractor': 'C0026',
  ...
  // });
  // // print('--------------> $value');
  //   // print(DateFormateUtils.getDate2Month(element['createdAt']));
  //  });

  //  value.where((element) => tempList.add(element).toList());

  //  var distinctIds = value.toSet().toList();
  //  print(distinctIds);
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // TextButton(onPressed: (){sort();}, child: Text('click')),
                ],
              ),
            ),
