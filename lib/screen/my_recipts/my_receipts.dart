...
import 'package:origa/screen/my_recipts/bloc/myreceipts_bloc.dart';
...
class _MyReceiptsBottomSheetState extends State<MyReceiptsBottomSheet> {
    ...
    return Container(
      ...
      child: StatefulBuilder(
        ...
        return WillPopScope(
          ...
          child: BlocListener<MyreceiptsBloc, MyreceiptsState>(
            bloc: bloc,
            listener: (context, state) {
              // TODO: implement listener
            },
            child: BlocBuilder<MyreceiptsBloc, MyreceiptsState>(
              bloc: bloc,
  ...
  List<Widget> _buildFilterOptions() {
    List<Widget> widgets = [];
    bloc.filterOption.forEach((element) {
      ...
      child: Card(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(10),
            color: option == bloc.selectedFilter
