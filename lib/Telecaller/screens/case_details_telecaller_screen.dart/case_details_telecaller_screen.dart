...
class _CaseDetailsTelecallerScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<CasedetailsTelecallerBloc, CasedetailsTelecallerState>(
        bloc: bloc,
        listener: (context, state) {
          if (state is ClickCallTelecallerBottomSheetState) {
            callDetailsShowBottomSheet(context);
          }
        },
        child:
            BlocBuilder<CasedetailsTelecallerBloc, CasedetailsTelecallerState>(
          bloc: bloc,
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: CustomLoanUserDetails(
                                        userName: bloc.caseDetailsResult.result
                                                ?.caseDetails?.cust ??
                                            'DEBASISH PATNAIK',
